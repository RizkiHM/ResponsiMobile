...
@Component({
  ...
  templateUrl: './fakultas.page.html',
  styleUrls: ['./fakultas.page.scss'],
})
...
export class FakultasPage {
  ...
  paginateArray(){
    this.page++;
    return this.fakultas.filter(
      x=>x.urutan_list > (this.page * this.perPage) && x.urutan_list <= (this.page * this.perPage)
    );
  }
